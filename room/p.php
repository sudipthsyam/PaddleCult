...
// Check if "room_type" data is coming from the previous page
if (isset($_POST['room_type']) && !empty($_POST['room_type'])) {
    $value = $_POST['room_type'];
} else {
    $value = $booking_type;
}
...
if (isset($_POST['num_rooms']) && !empty($_POST['num_rooms'])) {
  $num_rooms_name = "x" . $_POST['num_rooms'] . " Rooms";
} else {
  $num_rooms_name = "";
}

$newcheckindifference="x" . $checkindifference;
      ...
      <div class="model">
        <div class="room">
          <div class="text-cover">
            <h1 style="color: white;"><?php echo  $value?></h1>
            <p class="price"> <?php echo $rate; ?>  <span>INR</span> / <?php echo $pricing_unit; ?></p>
            <hr>
    ...
    if (isValidDate(checkin_date) && isValidDate(checkout_date)) {
      ...
      formattedDatesElement.innerHTML = "<p >Invalid Date</p>";
          ...
          <div class="receipt-box">
            ...
            <table class="table">
              <tr>
                <td><?php echo $rate; ?><?php echo $num_rooms_name; ?>x<?php echo $num_guests; ?><?php echo $newcheckindifference; ?></td>
          ...
          <div class="payment-info">
            ...
            <input type="text" name="checkin_date"  value="<?php echo $checkin_date; ?>" id="checkin_date" readonly hidden required>   
                ...
                <input type="text" name="booking_type"  value="<?php echo $value; ?>" id="booking_type" readonly hidden required>   
