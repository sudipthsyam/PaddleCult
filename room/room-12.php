            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="room__details__title">
                        <h2>King Room with Garden View</h2>
                        ...
                        <div class="reservation-box">
                            <div class="top">
                                <form action="p2.php" method="post">
                                    ...
                                    <input  type="text" name="tid" readonly value="<?php echo $tid; ?>" placeholder="Transaction ID "><br>
                                        <input type="text"  id="rate" name="rate" value="7000" required>
                                        <input type="text"  id="num_guests" name="num_guests" value="2" required>
                                        <input type="text"  id="room_type" name="room_type" value="King Room with Garden View" required>
                                        <input type="text"  placeholder="checkindifference" id="checkindifference" name="checkindifference" required>
                                        <input type="text"  id="total" placeholder="total" name="total"  >
                                        <script>
   $(document).ready(function() {
    <script>
  $(document).ready(function() {
    ...
    const checkindifferenceInput = document.getElementById("checkindifference");
    const totalInput = document.getElementById("total");

    // Check if the elements were found
    console.log("rateInput:", rateInput);
    console.log("checkindifferenceInput:", checkindifferenceInput);
    console.log("totalInput:", totalInput);

    // Add an event listener to the checkindifference input field
    checkindifferenceInput.addEventListener("input", function () {
      // Parse the rate and checkindifference values as numbers
      const rate = parseFloat(rateInput.value);
      const checkindifference = parseFloat(checkindifferenceInput.value);

      console.log("Rate:", rate);
      console.log("Checkindifference:", checkindifference);

      // Check if both rate and checkindifference are valid numbers
      if (!isNaN(rate) && !isNaN(checkindifference)) {
        // Calculate the total and set it as the value of the "total" input field
        const total = rate * checkindifference;
        console.log("Total:", total);
        totalInput.value = total.toFixed(2);
      } else {
        // If the inputs are not valid numbers, set the "total" field to an error message
        ...
        .button-container:hover .button.ok:active {
          ...
          -webkit-filter: drop-shadow(0px 0px 3px #000);
                        ...
                        <div class="room__details__desc">
                            <h2>Description:</h2>
                            <p>"Experience the serene charm of our King Room with Garden View, designed for your utmost comfort and relaxation. This inviting room features air conditioning for a comfortable climate, a convenient tea and coffee maker, and a private balcony with picturesque garden views, perfect for enjoying your morning coffee or evening drink</p>
