    ...
    <div class="room-details-slider">
        <div class="container">
            <div class="room__details__pic__slider owl-carousel">
                <div class="room__details__pic__slider__item set-bg" data-setbg="https://paddlecult.com/images/room/rs-1.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="https://paddlecult.com/images/room/rs-2.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="https://paddlecult.com/images/room/rs-3.jpg"></div>
                <div class="room__details__pic__slider__item set-bg" data-setbg="https://paddlecult.com/images/room/rs-4.jpg"></div>
            </div>
        </div>
    </div>
                            ...
                            <div class="top">
                                <form action="p2.php" method="post">
                                    ...
                                    <input  type="text" name="tid" readonly value="<?php echo $tid; ?>" placeholder="Transaction ID " hidden><br>
                                        <input type="text"  id="rate" name="rate" value="4000" hidden required>
                                        <input type="text"  id="num_guests" name="num_guests" value="1" hidden required>
                                        <input type="text"  id="room_type" name="room_type" value="Standard Double Room" hidden required>
        ...
        .button-container:hover .button.ok:active {
          ...
          -webkit-filter: drop-shadow(0px 0px 3px #000);
                        ...
                        <div class="room__details__desc">
                            <h2>Description:</h2>
                            <p>Experience our Standard double room featuring a cozy bed with clean linens, a neatly arranged private bathroom and a functional cupboard and desk. The room is designed for comfort and convenience, aiming to provide guests with a relaxing and enjoyable stay during their time at the hotel.</p>
