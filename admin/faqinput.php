 ...
 <div class="container">
   ...
   <div class="collapse navbar-collapse" id="ftco-nav">
     <ul class="navbar-nav ml-auto">
      <li class="nav-item"><a href="bookingdetails.php" class="nav-link">Payment Details</a></li>
      <li class="nav-item active"><a href="faqinput.php" class="nav-link">FAQ</a></li>
    </ul>
		...
		<div class="container">
			<div class="row no-gutters">
				<div class="col-sm-4 p-4 p-md-5 d-flex align-items-center justify-content-center bg-primary">
					<form  class="appointment-form" action="add_faq.php" method="post">
						<h3 class="mb-3">Enter FAq quesions</h3>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<input type="text" class="form-control" placeholder="Qustion" name="question">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<textarea type="text" class="form-control" placeholder="Answer" name="answer"></textarea>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
