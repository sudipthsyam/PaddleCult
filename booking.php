...
$total = $_POST['total'];
$tid = $_POST['tid']; // Add this line

// Validate the input data (you can add more specific validation)

// Prepare and execute the SQL statement using prepared statements
$sql = "INSERT INTO bookings (name, email, phone, checkin_date, checkout_date, booking_type, num_guests, checkindifference, total, tid) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

$stmt = $conn->prepare($sql);

// The type definition string must match the number of bind variables
$stmt->bind_param("ssssssidds", $name, $email, $phone, $checkin_date, $checkout_date, $booking_type, $num_guests, $checkindifference, $total, $tid); // Add "s" for the tid
